        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RamBusSpeed = table.Column<int>(type: "integer", nullable: true),
                    RamSlots = table.Column<int>(type: "integer", nullable: true),
                    TdpWattage = table.Column<int>(type: "integer", nullable: true),
                    RecommendedPsu = table.Column<int>(type: "integer", nullable: true),
                    LengthMm = table.Column<int>(type: "integer", nullable: true),
                    AdditionalSpecsJson = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
